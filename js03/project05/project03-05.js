...
for (let i = 1; i <= phones.length; i++) {
   ...
   // Variable that will define the class of td elements used in creating the bar chart cells.
   let cellTag = document.getElementsByTagName("td");  
   ...
   let tableCell = document.getElementsByTagName("tbody")[0];
